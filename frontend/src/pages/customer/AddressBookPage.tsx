    ...
    <div className="animate-fade-in max-w-6xl mx-auto pb-16 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
            <BookOpen className="w-6 h-6 text-[#5046e4]" /> Saved Address Book
          </h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 delivero-card p-8 space-y-3">
          <MapPin className="w-12 h-12 text-slate-300 stroke-1 mx-auto" />
          ...
          <button onClick={() => setShowModal(true)} className="btn-primary text-xs font-bold shadow-sm mt-2 inline-flex items-center gap-1.5">
            <Plus className="w-4 h-4" /> Save First Address
          </button>
        </div>
      ) : (
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3 border-b border-slate-100 pb-2.5">
                  <span className="px-2.5 py-1 rounded-lg bg-indigo-50 text-[#5046e4] text-3xs font-black tracking-wide uppercase flex items-center gap-1">
                    <Tag className="w-3 h-3" /> {addr.label}
                  </span>
                  <button
                ...
                <p className="text-xs text-slate-500 font-mono font-semibold mt-0.5 flex items-center gap-1">
                  <Phone className="w-3 h-3 text-slate-400" /> {addr.contactPhone}
                </p>
              ...
              <div className="pt-3 mt-2 border-t border-slate-100 flex items-center justify-between text-3xs text-slate-400 font-mono">
                ...
                <span className="text-[#5046e4] font-bold group-hover:underline cursor-pointer flex items-center gap-0.5">
                  Use for booking <ArrowRight className="w-3 h-3" />
                </span>
              </div>
            </div>
          ))}
